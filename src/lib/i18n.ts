...
const translations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    giftMinus: 'Cadeau -1',
    giftPlus: 'Cadeau +1',
    giftsEnabledLabel: 'Cadeaus in het spel',
    giftsEnabledSub: 'Toon cadeaus en beloningen',
    ...
    lifeline: 'Hulplijn',
    maxPerChild: 'Max cadeaus per speler',
    ...
    audienceSub: 'Kies kind of volwassenen',
    audienceKids: 'Kinderen',
    audienceAdults: 'Volwassenen',
    aiPoolTitle: 'AI-vragenpakket',
    aiPoolSub: 'Maak je eigen vragen met ChatGPT',
    aiPoolNameLabel: 'Naam van je pakket',
    aiPoolNamePlaceholder: 'Bijv. Filmavond',
    aiPoolPromptLabel: 'Prompt voor vragen',
    aiPoolPromptPlaceholder: 'Bijv. grappige vragen over films, series en popcorn',
    aiPoolCountLabel: 'Aantal vragen',
    aiPoolCountSub: 'Kies hoeveel vragen je wilt',
    aiPoolApiKeyLabel: 'OpenAI API key',
    aiPoolApiKeyPlaceholder: 'sk-...',
    aiPoolSaveKey: 'Onthoud key op dit apparaat',
    aiPoolGenerate: 'Genereer pakket',
    aiPoolGenerating: 'Bezig met genereren...',
    aiPoolError: 'Er ging iets mis. Probeer het opnieuw.',
    aiPoolRemove: 'Verwijder',
    aiPoolRegenerate: 'Opnieuw maken',
    aiPoolListTitle: 'Jouw pakketten',
    aiPoolListSub: 'Beheer je eigen vraagsets',
    aiPoolListEmpty: 'Nog geen eigen pakketten',
    versionLabel: 'Versie',
    supportGame: 'Steun dit spel',
    settingsTitle: 'Instellingen',
    theme: 'Thema',
    themeChristmasEve: 'Kerstavond',
    themeChristmasDay: 'Eerste kerstdag',
    themeEaster: 'Pasen',
    themeSummer: 'Zomer',
    themeCozy: 'Gezellige avond',
  ...
  en: {
    ...
    giftMinus: 'Gift -1',
    giftPlus: 'Gift +1',
    giftsEnabledLabel: 'Gifts in the game',
    giftsEnabledSub: 'Show gifts and rewards',
    ...
    audienceSub: 'Choose kids or adults',
    audienceKids: 'Kids',
    audienceAdults: 'Adults',
    aiPoolTitle: 'AI question pool',
    aiPoolSub: 'Create your own questions with ChatGPT',
    aiPoolNameLabel: 'Pool name',
    aiPoolNamePlaceholder: 'E.g. Movie Night',
    aiPoolPromptLabel: 'Prompt for questions',
    aiPoolPromptPlaceholder: 'E.g. funny questions about movies, shows, and popcorn',
    aiPoolCountLabel: 'Question count',
    aiPoolCountSub: 'Choose how many questions you want',
    aiPoolApiKeyLabel: 'OpenAI API key',
    aiPoolApiKeyPlaceholder: 'sk-...',
    aiPoolSaveKey: 'Remember key on this device',
    aiPoolGenerate: 'Generate pool',
    aiPoolGenerating: 'Generating...',
    aiPoolError: 'Something went wrong. Try again.',
    aiPoolRemove: 'Remove',
    aiPoolRegenerate: 'Regenerate',
    aiPoolListTitle: 'Your pools',
    aiPoolListSub: 'Manage your custom sets',
    aiPoolListEmpty: 'No custom pools yet',
    versionLabel: 'Version',
    supportGame: 'Support this game',
    settingsTitle: 'Settings',
    theme: 'Theme',
    themeChristmasEve: 'Christmas Eve',
    themeChristmasDay: 'Christmas Day',
    themeEaster: 'Easter',
    themeSummer: 'Summer',
    themeCozy: 'Cozy night',
    themeSunset: 'Sunset',
    themeSlate: 'Classic',
